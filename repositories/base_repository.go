...
type BaseRepository[T any, C any] interface {
	Create(ctx context.Context, createDto any, args ...any) (string, error)
	BulkCreate(ctx context.Context, createDto []any, args ...any) ([]string, error)
	UpdateByPK(ctx context.Context, id string, updateDto any, args ...any) error
	...
	FindOneByPK(ctx context.Context, id string, config *C, args ...any) (*T, error)
	Delete(ctx context.Context, conditions any, args ...any) error
	DeleteOneByPK(ctx context.Context, id string, args ...any) error
